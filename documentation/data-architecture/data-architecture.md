...
This document outlines the key interfaces used in [Game Name], detailing their properties and purposes. These interfaces are essential for managing game data, player stats, and the overall game state.
